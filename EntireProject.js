/* This is the lambda function for the project, last updated 7/27 */
    ...
    var handlers = {
        ...
        'FoodHelpIntent' : function () {
            ...
            case 'deli':
                ...
                break;
            case 'Mexican':
                this.emit(':tell', 'There is a qdoba behind the whole foods at 64 halsey street.'); // not working por que?
                break;
            case 'mediterranean':
            ...
            case 'pizza':
                ...
                break;
            case 'Asian':
                this.emit(':tell', 'There is a wok to walk right across the street from military park.'); // not working also
                break;
            case 'barbecue':
        ...
        'gasLeak': function(){
            this.emit(':tell', 'Call 1 8 hundred, 8 8 0, 7 7 3 4 to report a gas leak. Open a window and leave the building');
        },
        
        'downedWire': function(){
            this.emit(':tell', 'Call 1 8 hundred, 8 8 0, 7 7 3 4 to report a downed wire. Stay away from fallen lines and anything or anyone that may have come in contact with them. ');
        },
